...
pub struct GetTodoViewModel {
    pub todo: Option<GetTodoReadModel>,
...
#[async_trait]
impl UseCaseOutputPort<GetTodoResponseModel> for GetTodoPresenter {
    async fn success(&self, output_data: GetTodoResponseModel) {
